...
public final class String
    ...
    */
     ...
     *
     * @diffblue.limitedSupport
     * Works as expected if the argument is one of the following:
     * <ul>
     *     <li> "US-ASCII" </li>
     *     <li> "UTF-16BE" </li>
     *     <li> "UTF-16LE" </li>
    ...
    public byte[] getBytes(String charsetName)
        ...
        // DIFFBLUE MODEL LIBRARY For now these conversions are not efficient so we force the string
        // to be ASCII.
        ...
        return getBytesAscii();
        // DIFFBLUE MODEL LIBRARY Does not seem to work:
