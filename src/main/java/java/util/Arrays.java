...
public class Arrays {
    ...
    public static boolean equals(double[] a, double[] a2) {
        ...
        for (int i=0; i<length; i++)
            ...
            //     return false;
            // DIFFBLUE MODEL LIBRARY
            // We use Double.equals instead of Double.doubleToLongBits as a workaround for TG-4330
            if (!((Double)a[i]).equals(a2[i]))
                return false;
    ...
    public static boolean equals(float[] a, float[] a2) {
        ...
        for (int i=0; i<length; i++)
            ...
            //     return false;
            // DIFFBLUE MODEL LIBRARY
            // We use Float.equals instead of Float.floatToIntBits as a workaround for TG-4330
            if (!((Float)a[i]).equals(a2[i]))
                return false;
