...
public class Collections {
    ...
    public static void reverse(List<?> list) {
        ...
        // Our model is identical to the "RandomAccess or small List" case from
        // the original JDK.
        int size = list.size();
        for (int i=0, mid=size>>1, j=size-1; i<mid; i++, j--)
            swap(list, i, j);
...
/**
        ...
        implements Serializable
    {
        ...
        // DIFFBLUE MODELS LIBRARY
        // Most of these methods are trivial so we only test size()
        // to ensure methods are called properly.
